...
function onNewComputer() {
    ...
    saveComputerModalElement.style.display = 'block'; saveComputerHeaderMessage.innerHTML = 'Yeni';
}
...
function onEditComputer(computerId) {
    ...
    saveComputerModalElement.style.display = 'block'; saveComputerHeaderMessage.innerHTML = 'Redaktə';
    setTimeout(() => {
